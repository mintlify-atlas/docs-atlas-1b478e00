...
<CardGroup cols={2}>
  <Card title="MHP30" icon="heat" href="https://ralim.github.io/IronOS/Flashing/MHP30">
    Mini Hot Plate flashing guide
  </Card>
  <Card title="Pinecil V1" icon="microchip" href="https://ralim.github.io/IronOS/Flashing/Pinecil%20V1/">
    Pine64 Pinecil V1 flashing guide
  </Card>
  <Card title="Pinecil V2" icon="microchip" href="https://ralim.github.io/IronOS/Flashing/Pinecil%20V2/">
    Pine64 Pinecil V2 flashing guide
  </Card>
  <Card title="TS80 / TS80P" icon="screwdriver-wrench" href="https://ralim.github.io/IronOS/Flashing/TS80%28P%29/">
    Miniware TS80/TS80P flashing guide
  </Card>
  <Card title="TS100" icon="screwdriver-wrench" href="https://ralim.github.io/IronOS/Flashing/TS100">
    Miniware TS100 flashing guide
  </Card>
  <Card title="TS101" icon="screwdriver-wrench">
    Miniware TS101 flashing guide
  </Card>
</CardGroup>
...
If you receive warnings about the accelerometer or USB-PD not being detected, please see the [hardware issues documentation](https://ralim.github.io/IronOS/HardwareIssues/).
...
<Warning>
If you see an **(X)** where the soldering iron icon should be, the firmware cannot detect the tip. Try removing and reinstalling the tip. If the issue persists, see the [hardware issues section](https://ralim.github.io/IronOS/HardwareIssues/).
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Hardware Issues" icon="triangle-exclamation" href="https://ralim.github.io/IronOS/HardwareIssues/">
